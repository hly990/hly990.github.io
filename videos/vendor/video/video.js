(function () {
    ...
    u.b = u.ka.extend({j: function (a, c, d) {
        this.c = a;
    ...
    t = u.q.prototype;
    t.e = function (a, c) {
        c = u.l.B({className: this.Q(), innerHTML: '<div class="vjs-control-content"><span class="vjs-control-text">' + (this.oa || "Need Text") + "</span></div>", role: "button", "aria-live": "polite", tabIndex: 0}, c);
    ...
    u.Xb = u.q.extend({j: function (a, c) {
        u.q.call(this, a, c);
    ...
    u.ab = u.b.extend({j: function (a, c) {
        u.b.call(this, a, c);
        a.d("timeupdate", u.bind(this, this.da))
    }});
    ...
    u.cc = u.b.extend({j: function (a, c) {
        u.b.call(this, a, c)
    }});
    ...
    u.ma = u.S.extend({j: function (a, c) {
        u.S.call(this, a, c);
        a.d("volumechange", u.bind(this, this.update));
    ...
    u.Fa = u.q.extend({j: function (a, c) {
        u.q.call(this, a, c);
    ...
    u.Vb = u.b.extend({j: function (a, c) {
        u.b.call(this, a, c);
    ...
    u.f = u.r.extend({j: function (a, c, d) {
        ...
        a = a.h;
        var k = u.l.B({readyFunction: "videojs.Flash.onReady", eventProxyFunction: "videojs.Flash.onEvent", errorEventProxyFunction: "videojs.Flash.onError", autoplay: a.autoplay, preload: a.Sa, loop: a.loop, muted: a.muted}, c.flashVars), r = u.l.B({wmode: "opaque", bgcolor: "#000000"}, c.params), n = u.l.B({id: j, name: j, "class": "vjs-tech"}, c.attributes), s;
    ...
    u.eb = u.X.extend({j: function (a, c) {
        c.track = {H: function () {
            return c.kind
        }, C: a, label: function () {
            return c.kind + " off"
    ...
    u.Ba = u.T.extend({j: function (a, c, d) {
        u.T.call(this, a, c, d);
    ...
    u.Ca = u.T.extend({j: function (a, c, d) {
        u.T.call(this, a, c, d);
